...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <!-- Property Listings -->
        <h2 class="text-xl font-semibold mb-6 text-foreground">Tin đăng dành cho bạn</h2>
...
@section('scripts')
    <script>
        ...
        function toggleFavorite(propertyId) {
            const icon = document.querySelector(`.favorite-icon[data-property-id="${propertyId}"]`);
            ...
            // Gửi request lên server để lưu trạng thái yêu thích

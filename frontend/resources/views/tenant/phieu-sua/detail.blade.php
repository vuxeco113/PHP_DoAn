...
<div class="container mx-auto p-4">
    ...
    <form id="phieuSuaForm" method="POST" action="{{ Route('tenant.phieu-sua.checkout',['id' => $phieuSua['id']]) }}">
        @csrf
        @method('POST')
        ...
        {{-- Nút cập nhật --}}
        @if($phieuSua['faultSource'] == 'khach_thue')
        <div class="mb-4">
            <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Thanh toán phiếu sửa</button>
        </div>
        @endif
    </form>
</div>
